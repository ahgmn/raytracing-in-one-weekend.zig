...
pub const Camera = struct {
    ...
    pixel_delta_v: Vec3,
    aspect_ratio: f32,
    pub fn render(self: *const @This(), world: *const hittable.HittableList, stdout: anytype, stderr: anytype) !void {
        ...
        for (0..self.image_height) |row| {
            ...
            for (0..self.image_width) |col| {
                ...
                const pixel_center = self.pixel00_loc + (self.pixel_delta_u * toVec(colf)) + (self.pixel_delta_v * toVec(rowf));
